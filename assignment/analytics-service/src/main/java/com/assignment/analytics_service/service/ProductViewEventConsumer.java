...
import com.assignment.analytics_service.event.ProductViewEvent;
...
public class ProductViewEventConsumer {
    ...
    public ProductViewEventConsumer(ReactiveKafkaConsumerTemplate<String, ProductViewEvent> template, ProductViewRepository repository) {
