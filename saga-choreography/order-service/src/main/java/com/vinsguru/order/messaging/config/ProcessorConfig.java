...
public class ProcessorConfig extends AbstractOrderEventRouterConfig {
    ...
    public ProcessorConfig(EventProcessor<InventoryEvent, OrderEvent> inventoryEventProcessor, EventProcessor<PaymentEvent, OrderEvent> paymentEventProcessor, EventProcessor<ShippingEvent, OrderEvent> shippingEventProcessor, EventPublisher<OrderEvent> eventPublisher) {
        this.inventoryEventProcessor = inventoryEventProcessor;
        this.paymentEventProcessor = paymentEventProcessor;
        this.shippingEventProcessor = shippingEventProcessor;
